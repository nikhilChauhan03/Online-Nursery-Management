...
//	------------------------------------------------------------RegisterPlantHandler------------------------------------------------------------------
	
	@PostMapping("/plants/{admin_userName}")
	public ResponseEntity<Plant> registerPlantHandler(@RequestBody Plant plant, @PathVariable String admin_userName)
			throws PlantException, AdminException{
...
//	-------------------------------------------------------------updatePlantHandler-------------------------------------------------------------------
	...
	public ResponseEntity<Plant>updatePlantsHandler(@RequestBody Plant plant,@PathVariable("admin_userName") String admin_userName)
			throws PlantException, AdminException{
...
//	----------------------------------------------------------deletePlantByIdHandler-----------------------------------------------------------------
	...
	public ResponseEntity<Plant>deletePlantByIdHandler(@PathVariable Integer plant_id, @PathVariable String admin_userName) 
			throws PlantException, AdminException{
...
//	--------------------------------------------------------getPlantByIdHandler-----------------------------------------------------------------
	...
	public ResponseEntity<Plant>getPlantByIdHandler(@PathVariable Integer plant_id, @PathVariable String userName)
			throws PlantException,CustomerException, AdminException{
...
//	--------------------------------------------------------getPlantByCommonNameHandler-------------------------------------------------------------------------------
	
	@GetMapping("/getplants/{plant_common_name}/{userName}")
	public ResponseEntity<Plant>getPlantByCommonNameHandler(@PathVariable String plant_common_name, @PathVariable String userName) 
			throws PlantException, CustomerException, AdminException{
